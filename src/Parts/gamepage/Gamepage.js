    ...
    <main>
      <section className="gamepage">
        ...
        <div className="description">
          ...
          Откроются ли перед вами врата Вальгаллы? Сейчас вы в Вальхейме — 10-м
          мире викингов. Одолейте могучих чудовищ этих земель и добейтесь
          расположения богов! На своем пути вы побываете в самых дальних уголках
          этого мира, от дремучих лесов до высочайших горных вершин. Создавайте
          могущественное оружие, стройте неприступные замки и отправляйтесь под
          парусами драккаров к самому горизонту.
          ...
          продвигаться, тем опаснее будет становиться мир вокруг. К счастью, по
          пути вас будут ждать не только опасности — вы также будете чаще
          находить ценные материалы, которые весьма пригодятся для создания
          смертоносного оружия и крепкой брони. Возводите крепости и заставы по
          всему миру! А со временем постройте несокрушимый драккар и отправьтесь
          покорять бескрайние океаны в поиске чужестранных земель... Но
          постарайтесь не заплыть слишком далеко...
          <br />
          <br />
